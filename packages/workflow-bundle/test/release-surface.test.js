...
const publicClaims = [
  ...
  ["README.md", "aligns the stale authoring smoke with the approved bootstrap behavior"],
  ...
  ["README.vi.md", "đồng bộ authoring smoke đã lỗi thời với hành vi bootstrap đã được phê duyệt"],
  ...
  ["packages/workflow-bundle/README.md", "aligns the stale authoring smoke with the approved bootstrap behavior"],
  ["packages/workflow-bundle/README.md", "### Roll Back From v2.6.1 To v2.6.0"],
  ...
  ["packages/workflow-bundle/README.vi.md", "đồng bộ authoring smoke đã lỗi thời với hành vi bootstrap đã được phê duyệt"],
  ["packages/workflow-bundle/README.vi.md", "### Roll Back Từ v2.6.1 Về v2.6.0"],
  ...
  ["docs/publish-surface.md", "aligns the stale authoring smoke with approved legacy-scaffold bootstrap behavior"],
  ...
  ["docs/publish-surface.vi.md", "đồng bộ authoring smoke đã lỗi thời với hành vi bootstrap legacy-scaffold đã được phê duyệt"],
...
if (fs.existsSync(path.join(repoRoot, releaseNotePath))) {
  ...
  assert(
    releaseNote.includes("Use the retained immutable v2.6.0 artifact and `wfc install` for the downgrade"),
    "release note must document the immutable rollback command boundary"
  );
  assert(
    releaseNote.includes("13/13 authoring smoke"),
    "release note must record corrected authoring-smoke evidence"
  );
  assert(
    releaseNote.includes("TD-01"),
    "release note must record the production approval-path regression evidence"
  );
  assert(
    releaseNote.includes("Remote Workflow Guardrails 9/9 and s08 QC evidence remain pending"),
