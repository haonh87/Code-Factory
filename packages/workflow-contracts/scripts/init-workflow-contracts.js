...
function getBootstrapFiles() {
  return [
    {
      relativePath: "workflow-contracts.config.json",
    ...
    },
    {
      ...
      content: "# Project Context\n\nContext tối thiểu cho workflow contracts.\n"
    },
    {
      relativePath: "project-context/constitution.md",
      content: "# Constitution\n\nNguyên tắc nền cho workflow contracts.\n"
    },
    {
...
function initWorkflowContracts(options) {
...
function runCli() {
  ...
  try {
    const result = initWorkflowContracts({
      projectRoot: args["project-root"],
      force: args.force
    });

    console.log(`OK: initialized workflow contracts baseline under ${result.projectRoot}`);
