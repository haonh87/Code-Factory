...
A minimal example combining text nodes and an edge:

```json
{
  "nodes": [
    { "id": "8a9b0c1d2e3f4a5b", "type": "text", "x": 0, "y": 0, "width": 300, "height": 150, "text": "# Main Idea\n\nThis is the central concept." },
    { "id": "1a2b3c4d5e6f7a8b", "type": "text", "x": 400, "y": -100, "width": 250, "height": 100, "text": "## Supporting Point\n\nDetails here." }
  ],
  "edges": [
...
See `references/examples.md` for full worked examples of a project board with groups, a research canvas mixing text/file/link nodes, and a flowchart with branching edges.
