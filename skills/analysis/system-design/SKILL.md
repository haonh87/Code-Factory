---
name: system-design
description: Chốt technical approach theo hướng DEV-led, kế thừa option thinking và hard-gate mạnh từ Superpowers nhưng giữ governance, traceability và architecture follow-up của repo. Dùng khi đã có business goal và acceptance criteria, cần khóa boundary, contract, data flow và validation plan trước implementation.
---
...
7. Liệt kê `component_changes`, `data_flow`, `interface_changes`.
