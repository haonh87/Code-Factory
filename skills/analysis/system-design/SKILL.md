...
- Chỉ ra khi nào cần gọi thêm skill kiến trúc chuyên biệt như `domain-architecture`, `frontend-architecture`, `database-design`, `deployment-devops`, `containerization-packaging`, `platform-runtime-deployment` hoặc `ci-cd-release`.
