...
Tài liệu này tách rõ đâu là public onboarding path của `workflow-bundle v2.6.2`, đâu là deep-dive docs, và đâu là maintainer context.

## Public Onboarding Docs

Đây là bộ nên đọc khi review ứng viên phát hành `workflow-bundle v2.6.2`.
...
- `README` trả lời repo này là gì và public promise của `v2.6.2` là gì.
