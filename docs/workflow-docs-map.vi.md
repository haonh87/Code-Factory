...
Tài liệu này tách rõ đâu là public onboarding path của `workflow-bundle v2.6.3`, đâu là deep-dive docs, và đâu là maintainer context.

## Public Onboarding Docs

Đây là bộ nên đọc khi review ứng viên phát hành `workflow-bundle v2.6.3`.
...
- `README` trả lời repo này là gì và public promise của `v2.6.3` là gì.
...
- [`../skills/guardrails/artifact-governance/SKILL.md`](../skills/guardrails/artifact-governance/SKILL.md)
...
- `architecture-modeling` định nghĩa stable model, view routing, draw.io ownership và quality contract cho architecture view.
- `artifact-governance` quyết định owning root/section và chặn artifact hoặc bản sao không có owner rõ.
...
- [`audits/code-factory-holistic-workflow-skill-remediation-plan.vi.md`](audits/code-factory-holistic-workflow-skill-remediation-plan.vi.md)
...
- `code-factory-holistic-workflow-skill-remediation-plan` là authority cấp portfolio hiện tại cho finding toàn bộ pack, thứ tự remediation, owner, gate và closure evidence.
