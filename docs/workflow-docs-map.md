...
This document separates the public onboarding path of `workflow-bundle v2.6.0` from the deep-dive docs and the maintainer context.

## Public Onboarding Docs

This is the set to read when reviewing the `v2.6.0` release candidate.
...
- `README` answers what this repo is and what the public promise of `v2.6.0` is.
