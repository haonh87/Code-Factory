...
Tài liệu này tách rõ đâu là public onboarding path của `workflow-bundle v2.2.0`, đâu là deep-dive docs, và đâu là maintainer context.

## Public Onboarding Docs

Đây là bộ nên đọc khi muốn bắt đầu đúng public release `v2.2.0`.
...
- `README` trả lời repo này là gì và public promise của `v2.2.0` là gì.
