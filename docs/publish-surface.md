...
Tài liệu này chốt public publish surface cho `workflow-bundle v2.2.1`.

`v2.2.1` là public release hiện tại của workflow này:
...
Hai lớp legacy trên hiện vẫn được giữ để migration êm hơn, nhưng không nên coi đó là core public story của `v2.2.1`.
...
- nếu nói về public release, dùng ngôn ngữ của `v2.2.1`
