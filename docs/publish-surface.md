...
Các phần dưới đây có thể tồn tại trong working tree hiện tại nhưng không thuộc public story của `v1.0.0`:

- `Work Item Materialization`
- `Work Item Protocol`
- các command `wfc materialize`, `wfc change-item`, `wfc work-item`, `wfc protocol`
- các script và docs hỗ trợ hai extension ở trên
...
- nếu nói về extension sau `v1.0.0`, phải gọi rõ đó là extension hoặc WIP tiếp theo
